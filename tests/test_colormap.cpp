...
TEST_CASE("Colormap::sample returns correct color at boundaries with 2 colors", "[colormap][sample]") {
    ...
    SECTION("t=0.0 returns first color") {
        ...
        REQUIRE(static_cast<int>(result.r) == 0);
        REQUIRE(static_cast<int>(result.g) == 0);
        REQUIRE(static_cast<int>(result.b) == 0);
    }

    SECTION("t=1.0 returns second color") {
        Color result = cmap.sample(1.0);
        REQUIRE(static_cast<int>(result.r) == 255);
        REQUIRE(static_cast<int>(result.g) == 255);
        REQUIRE(static_cast<int>(result.b) == 255);
    }
...
TEST_CASE("Colormap::sample returns correct colors between segments with 5 colors", "[colormap][sample]") {
    ...
    SECTION("t=0.2 returns color in first segment") {
        ...
        REQUIRE(static_cast<int>(result.r) == 51);
        REQUIRE(static_cast<int>(result.g) == 51);
        REQUIRE(static_cast<int>(result.b) == 51);
    }

    SECTION("t=0.4 returns color in second segment") {
        Color result = cmap.sample(0.4);
        REQUIRE(static_cast<int>(result.r) == 102);
        REQUIRE(static_cast<int>(result.g) == 102);
        REQUIRE(static_cast<int>(result.b) == 102);
    }
    
    SECTION("t=0.6 returns color in third segment") {
        Color result = cmap.sample(0.6);
        REQUIRE(static_cast<int>(result.r) == 153);
        REQUIRE(static_cast<int>(result.g) == 153);
        REQUIRE(static_cast<int>(result.b) == 153);
    }
    
    SECTION("t=0.8 returns color in fourth segment") {
        Color result = cmap.sample(0.8);
        REQUIRE(static_cast<int>(result.r) == 204);
        REQUIRE(static_cast<int>(result.g) == 204);
        REQUIRE(static_cast<int>(result.b) == 204);
    }
}
